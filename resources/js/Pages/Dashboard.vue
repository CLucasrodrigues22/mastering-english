        ...
        <div v-if="Object.keys(listings.data).length">
            <div class="mb-6">
                ...
                <div class="overflow-x-auto">
                    <table
                        class="w-full min-w-[600px] table-fixed border-collapse overflow-hidden rounded-md text-sm ring-1 ring-slate-300 dark:ring-slate-600 bg-white shadow-lg"
                    >
                        <thead
            ...
            <div v-if="listings.data.length > 10">
