...
const props = defineProps({ listing: Object, edit_listing_message: String, status: Boolean });
...
<template>
    ...
    <Container>
        <div class="mb-6">
            ...
            <SessionMessages
                v-if="status !== null"
                :message="edit_listing_message"
                :color_txt="status === false ? 'text-red-500' : undefined"
            />
        ...
        >
            ...
            <div>
                <Button color_btn="bg-green-500" :disabled="form.processing">Update</Button>
            </div>
        </form>
    </Container>
</template>
